# Born2beRoot
    ...
    > In my project I used Debian distro
<h2>This project aims to create a secure and well-configured Linux virtual machine that meets both security and performance standards, following the 42 school guidelines. </h2>
...
We install sudo, create two groups (sudo and user42), and configure the sudoers file to control privileges and logging.
...
### A Hypervisor is the software layer that creates and manages virtual machines. It acts as a bridge between the host hardware and the guest operating systems, allocating resources like CPU, memory, and storage. There are two main types:
...
In this project, we use VirtualBox, which is a Type 2 hypervisor.
